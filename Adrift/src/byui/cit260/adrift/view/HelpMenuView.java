    ...
    public boolean doAction(String value) {
        ...
        switch (choice) {
            case 'G': //Goal of the game
                this.console.println(ANSI_BLUE + "Survive on a desolate asteroid by mining"
            ...
            case 'M': //Move character
                this.console.println(ANSI_BLUE + "To move character simply enter the desired"
                    + ANSI_BLUE    + "location coordinates" + ANSI_RESET);
                break;
            case 'F': // calculate fuel
                this.console.println(ANSI_BLUE + "To calculate fuel input current location and"
                    + ANSI_BLUE    + "desired location" + ANSI_RESET);
                break;
            case 'O': // calculate O2
                this.console.println(ANSI_BLUE + "To calculate O2 input current location and"
                    + ANSI_BLUE    + "desired location" + ANSI_RESET);
                break;
            case 'T': // manufacture tools
                this.console.println(ANSI_BLUE + "To construct tool enter the desired tool"
                ...
                this.console.println(ANSI_BLUE + "To mine resources enter desired location"
                    + ANSI_BLUE    + "and choose which resource and amount you would like"
                    + ANSI_BLUE    + "to mine." + ANSI_RESET);
                break;
                case 'D': // Deliver resorces
                this.console.println(ANSI_BLUE + "You must deliver resources to the facility"
                    + ANSI_BLUE    + "in order to make tools, repair the ship, or refuel"
                    + ANSI_BLUE    + " the ship." + ANSI_RESET);
                break;
                case 'S': // Repair ship
                this.console.println(ANSI_BLUE + "You must repair the hull of the ship with"
